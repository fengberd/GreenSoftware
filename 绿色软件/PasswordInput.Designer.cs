namespace 绿色软件
{
    partial class PasswordInput
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "本软件受软件锁保护，请输入密码解锁";
			// 
			// textBox1
			// 
			...
			this.pictureBox3.Location = new System.Drawing.Point(192, 83);
			...
			this.pictureBox2.Location = new System.Drawing.Point(100, 83);
			...
			this.Text = "软件已锁定";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.PasswordInput_FormClosed);
